# @cosyte/fhir capabilities

The full capability readout for `@cosyte/fhir`: what each layer reads, checks and refuses, and what it
leaves open. The [README](../README.md) carries the install command, the quickstart and the short
status, and [docs.cosyte.com/fhir](https://docs.cosyte.com/fhir) carries the task-oriented
documentation: installation, the quickstart, core concepts, guides, current limits and
troubleshooting.
