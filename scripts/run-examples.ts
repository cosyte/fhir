 ...
 * its published name, `@cosyte/fhir`, which Node resolves through this package's own `exports` to
 * the built files in `dist/`. So the examples exercise what a consumer installs, and `pnpm build`
 * has to run first.
 *
